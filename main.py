    """
    Url Shortener Api Kdof3
    =======================
    Developer-ready web service for validateing requests with built-in validation.
    ...
    APP_NAME    = "Url Shortener Api Kdof3"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Developer-ready web service for validateing requests with built-in validation.")
